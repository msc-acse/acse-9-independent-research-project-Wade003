...
!         integer, parameter :: nonods=nx*ny, nsplt=12
         ...
         integer, parameter :: mx_ncola = 10*nonods
         ...
         INTEGER havwnod, havmat, na, nonods_dg, ncolm_dg, nloc, ele,k, i,j,ii, kloc 
         real dx,dy,x_wide,y_wide, xloc(3),yloc(3)
         real, allocatable :: wnod(:), a(:), coordinates(:,:)
         integer, allocatable :: findm_dg(:),colm_dg(:)
...
! Get the sparcity...
           ...
           call fsmfp( findm_dg,colm_dg,ncolm_dg, coordinates, nonods_dg )
...
! 
! 
! findm,colm,ncolm = fsmfp( coordinates, nonods )
      subroutine fsmfp( findm,colm,ncolm, coordinates, nonods )
