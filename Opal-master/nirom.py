...
import numpy as np
import sys
from nirom_tools import get_nirom_settings, read_in_snapshots, compress_snapshots, train_the_NIROM, predict_with_the_NIROM, predict_with_the_NIROM_2D_advection_GBN
...
#    sys.exit()
    ...
    if nirom_options.prediction.nTime == 0:
        ...
        if nirom_options.training.GPR :
            t_train, t_pred = train_the_NIROM(nirom_options, fwd_options, U_encoded)
